...
#Normalizing features using the standard scaling method
...
theta0_normalized, theta1_normalized = gradient_descent(x_train_normalized,y_train_normalized, L=0.1, epochs=150)
...
#Denormalizing theta1 and theta0 values
