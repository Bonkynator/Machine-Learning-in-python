...
def gradient_descent(X, y):
    ...
    theta0 = torch.zeros((), requires_grad=True) 
    ...
    for epoch in range(5001):
        ...
        # Clamp values for numerical stability to prevent NaN errors
...
print(f"\nFinal Accuracy (Standard Scaling) = {accuracy_stan:.2f}%")
print(f"Final Accuracy (Min-Max Scaling) = {accuracy_minmax:.2f}%")
...
plt.title('Logistic Regression: Training Loss Comparison', fontsize=14, fontweight='bold')
